			...
			<div className="w-full flex flex-col md:justify-end md:flex-row gap-3">
				...
				{!isReadonly && showButtonCreate && (
					<Link
						...
						className="flex items-center justify-center bg-blue-500 hover:bg-blue-600 w-full lg:w-auto space-x-2 text-white px-5 py-3 rounded-md transition-all text-center text-sm"
					>
